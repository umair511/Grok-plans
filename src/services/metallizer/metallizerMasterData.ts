...
export const MSL_GREEN_MIN_TRIM_MM = 18;
export const MSL_GREEN_MAX_TRIM_MM = 45;
...
export const DEFAULT_METALLIZER_SETTINGS: MetallizerMachineSettings = {
  ...
  min_trim_mm: 20,
  max_trim_mm: 30,
  green_min_trim_mm: MSL_GREEN_MIN_TRIM_MM, // 18 mm
  green_max_trim_mm: MSL_GREEN_MAX_TRIM_MM, // 45 mm
