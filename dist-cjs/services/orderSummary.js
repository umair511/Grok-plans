...
exports.calculateOrderFulfillmentSummary = calculateOrderFulfillmentSummary;
/**
 * Calculates accurate order-by-order planned vs remaining breakdown across all plans in a run.
 */
function calculateOrderFulfillmentSummary(film, originalOrders, plans, _remainingOrders) {
    ...
    const orderBreakdowns = filmOrig.map(orig => {
        ...
        plans.forEach(plan => {
            ...
            plan.items.forEach(it => {
                ...
                const isAttrMatch = (it.sales_order === orig.sales_order &&
